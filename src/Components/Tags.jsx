...
export default function Tags({ title, icon: Icon, subLinks }) {
    ...
    return (
        <div className='group'>
            <div className="links px-2 md:px-4 py-1 group-hover:border-opacity-100 border-l-4 border-opacity-0 border-[#65B2B2]">
                <Link to={`/${title}`}  onClick={handleToggleLinks} className='p-0 lg:p-2 w-full rounded-lg group-hover:bg-zinc-200 cursor-pointer flex items-center gap-4'>
